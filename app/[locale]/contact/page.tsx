...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: 'Contact Us | InkPress',
    description: 'Get in touch with the InkPress team. We\'d love to hear from you.',
  }
}
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Have a question or want to work together? We're here to help and would love to hear from you.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">hello@inkpress.com</p>
                  <p className="text-gray-600">support@inkpress.com</p>
                </div>
              </div>
