...
/**
 * Generate static params for all locales (so /{locale}/privacy-policy works for all languages).
 */
...
/**
 * Privacy Policy page (locale-scoped version).
 * Content is always in English per Requirement 21.1.
 * All locales share the same English privacy policy content.
 */
